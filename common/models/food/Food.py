...
class Food(db.Model):
    ...
    active_price = db.Column(db.Numeric(10, 2), nullable=False, server_default=db.FetchedValue())
    signal_price = db.Column(db.Numeric(10, 2), nullable=False, server_default=db.FetchedValue())
    ...
    study_content = db.Column(db.String(2000), nullable=False, server_default=db.FetchedValue())
